...
```
### For data preparation, you can use Enhanced Enviroment and Stock data processor automated classes for data and enviroment preparation in jupyter notebook provided
